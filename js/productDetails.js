...
document.querySelector("#company-name").innerHTML = productDetails.entreprise.nom
document.querySelector("#product-details-name").innerHTML = productDetails.name
document.querySelector("#product-details-description").innerHTML = productDetails.description
document.querySelector("#product-details-price").innerHTML = productDetails.price
if(productDetails.medias.length == 0){
    document.querySelector("#product-details-image").setAttribute('src', 'image/none.jpg' ) 
}else{
    document.querySelector("#product-details-image").setAttribute('src', productDetails.medias[0].link ) 
